...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-3.0.1-22c55e?style=for-the-badge&amp;logo=github&amp;logoColor=white" alt="Version">
...
<p align="center">
  GingerDev's Game Repack Repo is a standalone C# Windows Forms app with borderless Bootstrap-style tabs, saved theme families with light/dark mode, tray theme switching, bundled game-inspired fonts, first-run library building, local caching, cover art, sortable game cards, keyboard navigation, configurable tray support, automatic update handoff, and a compact details view.
</p>
...
<p>
  Every theme family includes Light and Dark modes, with game-inspired palettes like Cyberpunk, Minecraft, DOOM, Halo, Fallout, and Mario. See the full screenshot gallery in
  <a href="THEMES.md"><strong>THEMES.md</strong></a>.
</p>
...
<table>
  <tr>
    ...
    <td>Borderless Bootstrap-style interface with branded chrome, theme-matched tabs, saved theme families, light/dark mode, bundled theme fonts, custom window buttons, centered windows, custom controls, and polished game cards.</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    ...
    <td>Persists window size, window position, search text, sort state, favourites filter, and the chosen games-per-page setting between sessions.</td>
  </tr>
  <tr>
